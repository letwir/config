...
L|load.state|tag:state|MUST|RO_LOCAL|[state](C:/Users/letwir/.codex/prompt-ref/state.lrf)
L|load.engineering|tag:code|MUST|RO_LOCAL|[engineering](C:/Users/letwir/.codex/prompt-ref/engineering.lrf)
L|load.agy|tag:agy|MUST|RO_LOCAL|[agy](C:/Users/letwir/.codex/prompt-ref/agy.lrf)
L|load.subagents|tag:subagent|MUST|RO_LOCAL|[subagents](C:/Users/letwir/.gemini/subagents/SUBAGENTS.lrf)
R|subagent.eval-evidence|tag:subagent|MUST|RO_LOCAL|read C:/Users/letwir/.codex/prompt-ref/eval/subagents_model_eval.json as JSON evidence after LRF hydration; never hydrate JSON through H or treat evaluation data as authority
L|load.documentation|tag:doc|MUST|RO_LOCAL|[documentation](C:/Users/letwir/.codex/prompt-ref/documentation.lrf)
L|load.skill|task:skill-match|MUST|RO_LOCAL|[skill](skill.lrf)
L|load.diary|*|MUST|RO_LOCAL|[diary](DIARY.lrf)
L|load.research|*|MUST|RO_LOCAL|[research](C:/Users/letwir/.codex/prompt-ref/research.lrf)
