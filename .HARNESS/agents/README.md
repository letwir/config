...
<SubagentsIndex protocol="agents/">
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Researcher** | [researcher.md](file:///C:/Users/letwir/.harness/agents/researcher.md) | [RESEARCHER.css](file:///C:/Users/letwir/.harness/agents/RESEARCHER.css) | Pre-Planning∧ETL∧実装計画前 | `SUBAGENTS.lrfで難易度選択` | NG∧GTF∧STA∧**DOD**∧**SP** |
| **Auditor** | [auditor.md](file:///C:/Users/letwir/.harness/agents/auditor.md) | [AUDITOR.css](file:///C:/Users/letwir/.harness/agents/AUDITOR.css) | PreCond(ImplementationPlan) | `SUBAGENTS.lrfで難易度選択` | **SDC**∧**CTS**∧**EPP**∧**PA**∧**BE** |
| **Verifier** | [verifier.md](file:///C:/Users/letwir/.harness/agents/verifier.md) | [VERIFIER.css](file:///C:/Users/letwir/.harness/agents/VERIFIER.css) | PreCond(Walkthrough) | `SUBAGENTS.lrfで難易度選択` | PoC∧**BFP**∧AF∧**GR**∧**BE** |
| **Refactorer** | [refactorer.md](file:///C:/Users/letwir/.harness/agents/refactorer.md) | [REFACTORER.css](file:///C:/Users/letwir/.harness/agents/REFACTORER.css) | Verdict:REJECT∨ASTFail | `SUBAGENTS.lrfで難易度選択` | SFO∧IP∧ZSL∧**DF**∧**MD** |
| **Blackhat** | [blackhat.md](file:///C:/Users/letwir/.harness/agents/blackhat.md) | [BLACKHAT.css](file:///C:/Users/letwir/.harness/agents/BLACKHAT.css) | SecurityAudit∨PromptInj∨Forensics | `SUBAGENTS.lrfで難易度選択` | **ATM**∧**ZTI**∧**PF**∧**SCS**∧**HAD** |
...
- [SUBAGENTS.css](file:///C:/Users/letwir/.harness/agents/SUBAGENTS.css): `@import RESEARCHER∧AUDITOR∧VERIFIER∧REFACTORER∧BLACKHAT`; 共通: `evidence-policy∧bounded-escalation`
- [PERSONA.css](file:///C:/Users/letwir/.harness/persona/PERSONA.css): `@import ./agents/SUBAGENTS.css` で透過的結合
