...
L|load.index|*|MUST|RO_LOCAL|[index](index.lrf)
...
R|workflow.default|*|MUST|RO_LOCAL|default sequence=../etl/main.seq; alternate modes under ../etl/*.seq apply only when explicitly requested; execute phases in strict sequence PRECEDENT->EXPLORE->PLAN->PRE_VERIFY->CODE->POST_VERIFY->FINISH; do not skip gates
